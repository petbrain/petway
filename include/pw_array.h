...
[[nodiscard]] static inline bool _pw_array_append_utf8    (PwValuePtr array, char8_t*        item) { PwValue v = PW_NULL; if (!pw_create_string(item, &v)) { return false; } return _pw_array_append(array, &v); }
[[nodiscard]] static inline bool _pw_array_append_utf32   (PwValuePtr array, char32_t*       item) { _PwValue v = PwStaticStringUtf32(item); return _pw_array_append(array, &v); }
...
[[nodiscard]] static inline bool _pw_array_insert_utf8    (PwValuePtr array, unsigned index, char8_t*        item) { PwValue v = PW_NULL; if (!pw_create_string(item, &v)) { return false; } return _pw_array_insert(array, index, &v); }
[[nodiscard]] static inline bool _pw_array_insert_utf32   (PwValuePtr array, unsigned index, char32_t*       item) { _PwValue v = PwStaticStringUtf32(item); return _pw_array_insert(array, index, &v); }
